        ...
        <View style={styles.container}>
            ...
            <Animated.View style={{ transform: [{ scale: emailAnimation }] }}>
                <TextInput
                    ...
                    onFocus={() => bounceAnimation(emailAnimation)} //bouncea cunado clicekas en el input
                />
            </Animated.View>
            <Animated.View style={{ transform: [{ scale: passwordAnimation }] }}>
                <TextInput
                    ...
                    secureTextEntry
                    placeholderTextColor="#A9A9A9"
                    onFocus={() => bounceAnimation(passwordAnimation)} //bouncea cuanco clickeas en el input
                />
            </Animated.View>
            {!isLogin && (
